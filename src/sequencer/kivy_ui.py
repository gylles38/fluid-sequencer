...
###
    ...
    def play_pressed(self, instance):
        ...
        if self.is_looping:
            self.sequencer.play_range_enabled = False # Explicitly disable play range
            self.sequencer.set_loop_range(start_pos, end_pos)
            # When looping, always start from the beginning of the loop
            self.sequencer.play(start_beat=self.sequencer.loop_start_beat)
        else:
            ...
            # When playing a range, start from the beginning of the range
