...
class TrackWidget(BoxLayout):
    ...
    def __init__(self, track, track_index, sequencer_layout, **kwargs):
        ...
        # self.add_widget(self.info_section) # DEFERRED
        ...
        # self.add_widget(self.controls_section) # DEFERRED
        ...
        if isinstance(track, MidiTrack):
            ...
            # *** THE FIX: Add timeline FIRST, then fixed panels ***
        ...
        # Reverse children to get the correct visual order [fixed, timeline]
        # while maintaining the correct drawing order (timeline drawn first)
