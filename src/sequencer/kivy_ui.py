...
###
        ...
        self.scroll_view.bind(scroll_x=self.update_ruler_scroll)
    ...
    def update_ruler_scroll(self, instance, value):
        if hasattr(self, 'ruler'):
            self.ruler.scroll_x = value
    ...
    def handle_ruler_click(self, touch):
        ...
        scroll_offset_x = scroll_view.scroll_x * (track_widget.width - scroll_view.width)

        # Calculate the click position relative to the start of the ruler widget itself
        relative_click_x = touch.x - self.ruler.x
        ...
        pixels_per_beat = track_widget.width / track_widget.total_beats
