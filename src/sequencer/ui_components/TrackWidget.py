...
class TrackWidget(BoxLayout):
    ...
    def __init__(self, track, track_index, sequencer_layout, **kwargs):
        ...
        self.volume_slider = MDSlider(min=0, max=1, value=track.volume, orientation='vertical', size_hint_y=1, padding=0, track_width_active=dp(8), track_width_inactive=dp(8))
        ...
        self.pan_slider = MDSlider(min=-1, max=1, value=track.pan, orientation='vertical', size_hint_y=1, padding=0, track_width_active=dp(8), track_width_inactive=dp(8))
