...
# 1. Refactor EditorPianoKeyboard to use RelativeLayout, canvas.before, and robust labels
...
# 2. Ensure bi-directional scroll sync in KV
# Restore timeline_scroll.scroll_y: keyboard_sv.scroll_y if missing
if 'scroll_y: keyboard_sv.scroll_y' not in content:
    content = content.replace('id: timeline_scroll', 'id: timeline_scroll\n                scroll_y: keyboard_sv.scroll_y')

with open(filepath, 'w') as f:
    f.write(content)
print("Updated EditorPianoKeyboard with canvas.before and robust labels.")
