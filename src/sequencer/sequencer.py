...
class Sequencer(EventDispatcher):
    ...
    def play(self):
        ...
        # If stopped, play from the default start beat.
        # If paused, this will be handled by the pause method.
        if self.playback_state == "stopped":
    ...
    def stop(self):
        ...
        try:
            ...
            print(f"\n[DIAGNOSTIC] --- STOPPING and rewinding to default start beat {self._default_start_beat:.6f} ---")
            self._resync_all_at_beat(self._default_start_beat, force_play=False)
